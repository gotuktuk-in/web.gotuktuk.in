...
(function (e, t, n, r) {
        ...
        init: function (e, t) {
            ...
            if (t.type === "singlePage") {
                ...
                t.content.on("click" + s, t.options.singlePageDelegate, function (e) {
                    e.preventDefault();
                    var n, r = t.dataArray.length, i = this.getAttribute("href");
                    for (n = 0; n < r; n++) {
            ...
            var t = this;
            t.wrap = e("<div/>", {"class": "cbp-popup-singlePageInline"}).on("click" + s, function (n) {
                if (t.stopEvents) {
                    return
                }
                var r = e(n.target).attr("data-action");
            ...
            e.each(r.find(s.options.lightboxDelegate), function (t, n) {
                ...
                if (e.inArray(r, a) === -1) {
                    ...
                    s.dataArray.push({src: i, title: n.getAttribute(s.options.lightboxTitleSrc), type: f});
                    o++
                }
                a.push(r)
            });
            ...
            e("html").css({overflow: "hidden", paddingRight: t.outerWidth - e(n).width()});
            s.wrap.show();
            ...
            var s = this, o = 0, u = 0, a = 0, f, l = [], c, h;
            i = i || false;
            s.storeBlocks = n;
            s.storeCurrentBlock = r;
            if (s.isOpen) {
                if (s.dataArray[s.current].url != r.getAttribute("href")) {
                    s.cubeportfolio.singlePageInline.close("open", {blocks: n, currentBlock: r, fromOpen: true})
                } else {
                    s.close()
                }
                return
            ...
            if (s.options.singlePageInlineInFocus) {
                s.scrollTop = e(t).scrollTop();
                e("body, html").animate({scrollTop: s.wrap.offset().top - 150})
            }
            ...
            n.wrap.css({height: n.height});
            n.wrap.css({top: n.top});
            ...
            if (n.options.singlePageInlineInFocus) {
                e("body, html").animate({scrollTop: n.wrap.offset().top - 150})
            }
            ...
            if (i.type === "singlePageInline") {
                if (n === "open") {
                    ...
                    if (i.options.singlePageInlineInFocus) {
                        e("body, html").animate({scrollTop: i.scrollTop})
                    }
                }
                ...
                setTimeout(function () {
                    i.stopScroll = true;
                    i.navigationWrap.css({top: i.wrap.scrollTop()});
                    i.wrap.removeClass("cbp-popup-singlePage-open cbp-popup-singlePage-sticky");
                    if (i.cubeportfolio.browser === "ie8" || i.cubeportfolio.browser === "ie9") {
                        i.content.html("");
                        i.wrap.detach();
                        e("html").css({overflow: "", paddingRight: ""});
    ...
    var u = {
        _init: function (t, n) {
            ...
            n = e("<div/>", {"class": "cbp-slider-arrowWrap"}).appendTo(t.$obj);
            e("<div/>", {"class": "cbp-slider-arrowNext", "data-action": "nextItem"}).appendTo(n);
            e("<div/>", {"class": "cbp-slider-arrowPrev", "data-action": "prevItem"}).appendTo(n);
            r = e("<div/>", {"class": "cbp-slider-bulletWrap"}).appendTo(t.$obj);
            for (var i = 0; i < t.$liLength; i++) {
                var s = i === 0 ? " cbp-slider-bullet-current" : "";
                e("<div/>", {"class": "cbp-slider-bullet" + s, "data-action": "jumpToItem"}).appendTo(r)
            }
        }, _events: function () {
            var t = this;
    ...
    var a = {
        _main: function (t, n, r) {
            ...
            var e = this, n = navigator.appVersion, r, i;
            ...
            t.blocksAvailable.each(function (n, r) {
                var i = e(r), s = Math.ceil(i.outerWidth() / t.localColumnWidth), o = 0;
                s = Math.min(s, t.cols);
            ...
            t.blocks.each(function (r, i) {
                ...
                if (!o) {
                    o = e.data(this, "cbp-wxh", {width: s.outerWidth(), height: s.outerHeight()})
                }
            ...
            n.$obj[e]({height: n.height - n.options.gapHorizontal}, 400)
            ...
            var r = this, i = Math.min.apply(Math, t), s = 0, o, u, a, f, l, c;
            ...
            u = Math.round(i);
            r.styleQueue.push({$el: e, style: r.supportCSSTransform ? r._withCSS3(o, u) : r._withCSS2(o, u)});
            ...
            r.blocksAvailable = r.blocks.filter(n);
            if (e.length) {
                r.styleQueue.push({$el: e, style: {skew: [50, 0], scale: .01, opacity: 0}})
            }
            if (t.length) {
            ...
            r._layout();
            o[r.transition]({left: "-100%", opacity: 0}).removeClass("cbp-wrapper-front").addClass("cbp-wrapper-back");
            i[r.transition]({left: 0, opacity: 1}).addClass("cbp-wrapper-front").removeClass("cbp-wrapper-back");
            r._processStyle(r.transitionByFilter);
            r._resizeMainContainer(r.transition);
            setTimeout(function () {
                r._filterFinish()
            ...
            r.blocksAvailable = s.filter(n);
            r._layout();
            o[r.transition]({top: "-100%", opacity: 0}).removeClass("cbp-wrapper-front").addClass("cbp-wrapper-back");
            i[r.transition]({top: 0, opacity: 1}).addClass("cbp-wrapper-front").removeClass("cbp-wrapper-back");
            r._processStyle(r.transitionByFilter);
            r._resizeMainContainer(r.transition);
            setTimeout(function () {
                r._filterFinish()
            ...
            o.blocksAvailable.css({opacity: 1});
            ...
            if (o.transition === "css") {
                ...
                l.find(".cbp-item-wrapper").animate({left: "-100%"}, 400, function () {
                    o._filterFinish()
                });
                c.find(".cbp-item-wrapper").css("left", "100%");
                c.find(".cbp-item-wrapper").animate({left: 0}, 400)
            }
            ...
            var i = r || e.data(this, "cubeportfolio"), s, o;
            if (!i) {
            ...
            var r = this, i = e.data(r, "cubeportfolio"), s, o, u, f;
            if (!i) {
            ...
            var r = e.data(this, "cubeportfolio"), i, s, o, u;
            if (e.isFunction(n)) {
            ...
            u.animate({opacity: 1}, 800, function () {
                switch (r.options.animationType) {
                    case"bounceLeft":
                    case"bounceTop":
                    case"bounceBottom":
